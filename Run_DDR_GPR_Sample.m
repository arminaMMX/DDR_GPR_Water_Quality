%% Chla prediction using DDR-GPR model
...
[DDRFeatureValues, DDRFeatureNames] = ...
                        Feature_Selection_DDR(features, Chl, featureNames);

%% DDR-GPR prediction
[ChlPred_Tran, ChlPred_Test, ChlTran, ChlTest] = Predict_GPR(DDRFeatureValues, Chl);

%% Metrics
MetricsTran = calculate_metrics(ChlTran, ChlPred_Tran);
MetricsTest = calculate_metrics(ChlTest, ChlPred_Test);

disp('========== DDR-GPR Performance Metrics ==========')
